...
def process_ts(list_of_feature_fns: List[callable], ts_data: Tuple[int, Dict[str, List[float]]]) -> Tuple[List[float], int]:
    """
...
def construct_features_df_parallel(list_of_ts: Dict[int, Dict[str, List[float]]], list_of_feature_fns: List[callable]) -> Tuple[pd.DataFrame, pd.Series]:
    """
